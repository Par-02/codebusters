...
export default function LoginForParent() {
    ...
    const handleSubmit = (event) => {
        ...
        // Check if both studentId and password are filled
        ...
        <Image src={bg1} alt="Background Image" layout="fill" className="z-[-5] object-fill"/>
            <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
                ...
                <div className="mb-5 mt-10">
                    <label htmlFor="text" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Student Id</label>
                    <input type="text" id="text" value={studentId} onChange={(e) => setStudentId(e.target.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
                <div className="mb-5">
